...
| 5.16 | Completed | operator-managed product type onboarding 구현 | DB-managed product type registry + AI-assisted discovery/extraction/normalization + official-grounding auto-validation eligibility + bounded residual Review AI autopilot | Backend, Frontend, AI/Data | 5.15 | 2026-05-17 |
