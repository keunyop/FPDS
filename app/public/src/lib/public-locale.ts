...
const PUBLIC_MESSAGES: Record<PublicLocale, PublicMessages> = {
  en: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "Higher rates within the selected type, currency and term.",
      ...
      loanTopSubtitle: "Lower comparable rates within the selected product conditions.",
      loanTopEmpty: "No comparable loan rates for these conditions.",
  ...
  ko: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "선택한 유형·통화·만기가 같은 금리를 비교합니다.",
      depositTopEmpty: "현재 범위에는 숫자 금리가 공개된 예금 상품이 없습니다.",
      depositTopUnavailable: "현재 예금 금리를 불러올 수 없습니다.",
      moreDeposits: "예금 더보기",
      loanTopTitle: "대출 Top 5",
      loanTopSubtitle: "선택한 상품 조건에서 비교 가능한 금리가 낮은 순입니다.",
      loanTopEmpty: "이 조건으로 비교할 수 있는 대출 금리가 없습니다.",
  ...
  ja: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "選択した種類・通貨・期間が同じ金利を比較します。",
      ...
      loanTopSubtitle: "選択した商品条件で比較可能な金利が低い順です。",
      loanTopEmpty: "この条件で比較できるローン金利はありません。",
