...
const PUBLIC_MESSAGES: Record<PublicLocale, PublicMessages> = {
  en: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "Highest comparable full rates. Ranges, margins and conditional or promotional rates are excluded.",
      ...
      loanTopSubtitle: "Lowest comparable full rates. Ranges, margins and conditional or promotional rates are excluded.",
  ...
  ko: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "비교 가능한 전체 금리가 높은 순입니다. 범위·가산율·조건부·프로모션 금리는 제외합니다.",
      depositTopEmpty: "현재 범위에는 숫자 금리가 공개된 예금 상품이 없습니다.",
      depositTopUnavailable: "현재 예금 금리를 불러올 수 없습니다.",
      moreDeposits: "예금 더보기",
      loanTopTitle: "대출 Top 5",
      loanTopSubtitle: "비교 가능한 전체 금리가 낮은 순입니다. 범위·가산율·조건부·프로모션 금리는 제외합니다.",
  ...
  ja: {
    ...
    dashboard: {
      ...
      depositTopSubtitle: "比較可能な全体金利が高い順です。範囲・上乗せ・条件付き・キャンペーン金利は除外します。",
      ...
      loanTopSubtitle: "比較可能な全体金利が低い順です。範囲・上乗せ・条件付き・キャンペーン金利は除外します。",
...
const PUBLIC_RECOMMENDATION_COPY: Record<PublicLocale, PublicRecommendationCopy> = {
  en: {
    ...
    metricUnavailable: 'No comparable value is available. Rate ranges, reference-rate margins, conditional rates and promotions are excluded from rate comparisons.',
  ...
  ko: {
    ...
    currentProduct: '내 상품',
    metricUnavailable: '비교 가능한 수치가 없습니다. 금리 범위, 기준금리 가산·차감, 조건부 금리와 프로모션은 금리 비교에서 제외합니다.',
  ...
  ja: {
    ...
    metricUnavailable: '比較可能な数値がありません。金利範囲、基準金利への加減算、条件付き金利、キャンペーンは金利比較から除外します。',
