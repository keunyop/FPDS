...
- recognized Canada bank/credit-union additions use official homepage favicon/logo URLs in the `BankLogo` mapping until local logo assets are explicitly approved for each brand
