  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid max-h-[90vh] w-[min(96vw,72rem)] -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto rounded-[1.75rem] border border-border/80 bg-popover text-popover-foreground shadow-xl duration-200 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
