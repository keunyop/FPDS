...
export function AdminAuthFrame({
  ...
  return (
    <section className={cn("min-h-svh bg-background p-3 sm:p-5", className)}>
      <div className="mx-auto grid min-h-[calc(100svh-1.5rem)] w-full max-w-5xl overflow-hidden border border-border bg-card sm:min-h-[calc(100svh-2.5rem)] lg:grid-cols-[0.86fr_1.14fr]">
        <aside className="flex flex-col justify-between bg-sidebar p-6 text-sidebar-foreground sm:p-8 lg:p-10">
          <div>
            ...
            <p className="mt-3 max-w-md text-2xl font-semibold leading-tight tracking-[-0.025em] sm:text-3xl">
              {copy.thesis}
            </p>
          </div>
        ...
        <main className="flex items-center px-5 py-8 sm:px-10 sm:py-12 lg:px-16">
