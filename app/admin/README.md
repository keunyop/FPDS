...
- `/admin/banks` and the bank-centered collect actions now surface homepage discovery outcomes directly, including the no-detail case where discovery completed but no candidate-producing detail sources were identified so no collection run was launched
