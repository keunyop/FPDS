...
- protected `/admin/sources` generated source registry list with white summary cards, bank/country/product/status/role filters, bounded table overflow inside the application shell, URL wrapping, and read-only drill-in
