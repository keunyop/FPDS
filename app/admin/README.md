...
- Review Detail AI verification forces a live lookup within the selected bank's registered official domains, presents cited match/mismatch/unverified field comparisons in EN/KO/JA, and lets reviewers stage one or all contract-safe corrections in the existing edit form; it never approves, publishes, or mutates the candidate by itself
